...
#pragma config(Motor,  port2,           frontRightMotor, tmotorVex393_MC29, openLoop, driveRight)
#pragma config(Motor,  port3,           backLeftMotor, tmotorVex393_MC29, openLoop, driveLeft)
#pragma config(Motor,  port4,           backRightMotor, tmotorVex393_MC29, openLoop, driveRight)
